...
def get_website_settings(context=None):
	...
	settings: "WebSettings" = frappe.get_cached_doc("Web Settings")
...
def get_items(parentfield: str) -> list[dict]:
	_items = frappe.get_all(
		"Front Navbar Item",
		filters={"parent": "Web Settings", "parentfield": parentfield},
		order_by="idx asc",
		fields="*",
	)
...
def get_auto_account_deletion():
	return frappe.db.get_single_value("Web Settings", "auto_account_deletion")
